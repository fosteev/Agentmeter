...
const SPEC_LINES: Record<string, Array<[number, number]>> = {
  ...
  // «≈ оценка» (408), плюс рамка заголовка (406). Кнопка «спросить» рисуется
  // теми же 10 px и той же линией, других чисел у неё нет.
  'LimitsAside.tsx': [[406, 409]],
  ...
  // `AgentRow`: строкой ленты (619–631) и полосой в карточке задачи (850).
