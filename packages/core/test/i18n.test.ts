...
const VALUES: Record<string, Record<string, string | number>> = {
  ...
  // Расход хода — то же худшее число, что у полосы доли: знак оценки и четыре
  // знака мантиссы. Ход длиной в 203 миллиона бывает: сессия с картинками.
  'today.turnSpend': { tokens: '≈203.5M' },
  // Худшее из встречающихся: трёхзначный охват. Сессий за день бывает 617.
  'breakdown.detailIn': { count: 617, total: 617 },
}
