...
export const en = {
  ...
  breakdown: {
    ...
    marginalRest: 'Model answers, your input and context reads',
    marginalRestRequests_one: '{{count}} request',
    marginalRestRequests_other: '{{count}} requests',
    marginalTotalDay: 'One-off spend for the day',
    marginalTotalSession: 'One-off spend per session',
    ...
    emptyFilter: 'No requests under the selected filter',
    loading: 'Loading the breakdown…',
    filterNote: 'feed filter: {{value}}',
    dayNote: 'day from history: {{date}}',
    dayReset: 'Back to today',
    sessions_one: '{{count}} session',
    sessions_other: '{{count}} sessions',
  ...
  history: {
    ...
    projects: 'Projects',
    openBreakdown: 'Breakdown for this day',
    total: 'total',
