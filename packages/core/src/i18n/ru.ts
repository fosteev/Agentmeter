...
export const ru = {
  ...
  caveat: {
    ...
    observedWindow: 'размер окна Claude в логи не пишется — выведен из наблюдавшегося максимума, этап 2.6',
  ...
  note: {
    ...
    images_one: '{{count}} картинка в результате — плотнее текста в тринадцать раз, {{tokens}} в промпт',
    images_few: '{{count}} картинки в результате — плотнее текста в тринадцать раз, {{tokens}} в промпт',
    images_many: '{{count}} картинок в результате — плотнее текста в тринадцать раз, {{tokens}} в промпт',
    ...
    toolImages_one: '{{count}} вызов с картинками — они плотнее текста в тринадцать раз, по {{per}} на вызов',
    toolImages_few: '{{count}} вызова с картинками — они плотнее текста в тринадцать раз, по {{per}} на вызов',
    toolImages_many: '{{count}} вызовов с картинками — они плотнее текста в тринадцать раз, по {{per}} на вызов',
  ...
  cli: {
    ...
    reconstructedSessions: 'Сессии с измеренной поправкой: {{count}}',
